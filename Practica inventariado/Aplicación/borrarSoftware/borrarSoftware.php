<?php
    ...
    $sql = "DELETE FROM software WHERE id=$borrar->id";
    $resultado = mysqli_query($conexion, $sql);

    //Mando el mensaje de respuesta
    if ($resultado){
        $respuesta["error"] = 0;
        $respuesta["mensaje"] = "Baja de software realizada"; 
    }
    else{
        $respuesta["error"] = 1;
        $respuesta["mensaje"] = "Error en el proceso de baja de software: ".mysqli_error($conexion);
    }
    //Codifico los datos
