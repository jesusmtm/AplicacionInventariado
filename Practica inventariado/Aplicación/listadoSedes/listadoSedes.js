"use strict"
//# sourceURL=listadoSedes.js

$(document).ready(function() {
    getListaSedes();
});

function getListaSedes(){
    $.get(
        "listadoSedes/listadoSedes.php",
        null,
        procesoRespuesta,
        "html"
    );
...
document.querySelector("#mnuListaSedes").addEventListener("click", getListaSedes, false);