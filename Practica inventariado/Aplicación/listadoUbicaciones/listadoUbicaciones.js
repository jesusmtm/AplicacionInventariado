"use strict"
//# sourceURL=listadoUbicaciones.js

getListaUbicaciones();

function getListaUbicaciones(){
    $.get(
        "listadoUbicaciones/listadoUbicaciones.php",
        null,
        procesoRespuesta,
        "html"
    );
...
document.querySelector("#mnuListaUbicaciones").addEventListener("click", getListaUbicaciones, false);